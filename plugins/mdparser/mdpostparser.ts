...
import {BlogTplEngine} from '../../lib/template/blogtpl';
import {ISummaryElement} from '../../interface/data';
import {PostParser} from '../../lib/parsing/parser';

export class MDPostParser extends PostParser
{
    ...
    public  SetTemplateEngine(templateEngine)
    {
